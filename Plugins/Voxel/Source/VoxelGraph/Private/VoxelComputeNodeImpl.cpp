...
TVoxelMap<FName, FVoxelNodeISPCPtr> GVoxelNodeISPCPtrs;
...
VOXEL_RUN_ON_STARTUP_GAME()
{
	...
	TArray<UScriptStruct*> AllStructs = GetDerivedStructs<FVoxelComputeNode>();
	...
	for (const auto& It : HeaderToStructs)
	{
		...
		{
			const TSharedRef<FVoxelComputeNode> Node = MakeSharedStruct<FVoxelComputeNode>(Struct);
			...
			ISPCFunctions += FVoxelComputeNodeImpl::GenerateFunction(*Node, ISPCIncludes);
		}
		...
		FVoxelComputeNodeImpl::FormatCode(ISPCFunctions);
...
int32 FVoxelComputeNodeImpl::GetRegisterWidth(const FVoxelPinType& Type)
{
...
FVoxelPinType FVoxelComputeNodeImpl::GetRegisterType(const FVoxelPinType& Type)
{
	const FVoxelPinType InnerType = Type.GetInnerType();
		...
		InnerType.Is<FIntVector4>())
	{
		...
		InnerType.Is<FInt64Vector4>())
	{
		return FVoxelPinType::Make<int64>();
	}
	else
	{
		check(false);
...
void FVoxelComputeNodeImpl::FormatCode(FString& Code)
{
...
FString FVoxelComputeNodeImpl::GenerateFunction(const FVoxelComputeNode& Node, TSet<FString>& OutIncludes)
{
	VOXEL_FUNCTION_COUNTER();

	FString Result;
	Result += "export void VoxelNode_" + Node.GetStruct()->GetName() + "(const FVoxelInputBuffer* uniform InputBuffers, void* uniform const* uniform OutputBuffers, const uniform int32 Num)";
	Result += "{";
...

	{
		...
		for (const FVoxelPin& Pin : Node.GetPins())
		{
			...
			if (Type.Is<bool>())
			{
				...
				Result += "const bool " + Pin.Name.ToString() + " = LoadBool(InputBuffers[" + FString::FromInt(Index) + "], Index);";
			}
			else if (Type.Is<uint8>())
			{
				const int32 Index = BufferIndex++;
				Result += "const uint8 " + Pin.Name.ToString() + " = LoadByte(InputBuffers[" + FString::FromInt(Index) + "], Index);";
			}
			else if (Type.Is<float>())
			{
				const int32 Index = BufferIndex++;
				Result += "const float " + Pin.Name.ToString() + " = LoadFloat(InputBuffers[" + FString::FromInt(Index) + "], Index);";
			}
			else if (Type.Is<FVector2D>() || Type.Is<FVoxelFloatRange>())
			{
				...
				Result += "const float2 " + Pin.Name.ToString() + " = MakeFloat2(" +
					"LoadFloat(InputBuffers[" + FString::FromInt(IndexX) + "], Index), " +
					"LoadFloat(InputBuffers[" + FString::FromInt(IndexY) + "], Index));";
			}
			else if (Type.Is<FVector>())
			{
				...
				Result += "const float3 " + Pin.Name.ToString() + " = MakeFloat3(" +
					"LoadFloat(InputBuffers[" + FString::FromInt(IndexX) + "], Index), " +
					"LoadFloat(InputBuffers[" + FString::FromInt(IndexY) + "], Index), " +
					"LoadFloat(InputBuffers[" + FString::FromInt(IndexZ) + "], Index));";
			}
			else if (Type.Is<FQuat>() || Type.Is<FLinearColor>())
			{
				...
				Result += "const float4 " + Pin.Name.ToString() + " = MakeFloat4(" +
					...
					"LoadFloat(InputBuffers[" + FString::FromInt(IndexY) + "], Index), " +
					"LoadFloat(InputBuffers[" + FString::FromInt(IndexZ) + "], Index), " +
					"LoadFloat(InputBuffers[" + FString::FromInt(IndexW) + "], Index));";
			}
			else if (Type.Is<double>())
			{
				const int32 Index = BufferIndex++;
				Result += "const double " + Pin.Name.ToString() + " = LoadDouble(InputBuffers[" + FString::FromInt(Index) + "], Index);";
			}
			else if (Type.Is<FVoxelDoubleVector2D>())
			{
				...
				Result += "const double2 " + Pin.Name.ToString() + " = MakeDouble2(" +
					"LoadDouble(InputBuffers[" + FString::FromInt(IndexX) + "], Index), " +
					"LoadDouble(InputBuffers[" + FString::FromInt(IndexY) + "], Index));";
			}
			else if (Type.Is<FVoxelDoubleVector>())
			{
				...
				Result += "const double3 " + Pin.Name.ToString() + " = MakeDouble3(" +
					"LoadDouble(InputBuffers[" + FString::FromInt(IndexX) + "], Index), " +
					"LoadDouble(InputBuffers[" + FString::FromInt(IndexY) + "], Index), " +
					"LoadDouble(InputBuffers[" + FString::FromInt(IndexZ) + "], Index));";
			}
			else if (Type.Is<FVoxelDoubleQuat>() || Type.Is<FVoxelDoubleLinearColor>())
			{
				...
				Result += "const double4 " + Pin.Name.ToString() + " = MakeDouble4(" +
					...
					"LoadDouble(InputBuffers[" + FString::FromInt(IndexY) + "], Index), " +
					"LoadDouble(InputBuffers[" + FString::FromInt(IndexZ) + "], Index), " +
					"LoadDouble(InputBuffers[" + FString::FromInt(IndexW) + "], Index));";
			}
			else if (Type.Is<int32>() || Type.Is<FVoxelSeed>())
			{
				const int32 Index = BufferIndex++;
				Result += "const int32 " + Pin.Name.ToString() + " = LoadInt32(InputBuffers[" + FString::FromInt(Index) + "], Index);";
			}
			else if (Type.Is<FIntPoint>() || Type.Is<FVoxelInt32Range>())
			{
				...
				Result += "const int2 " + Pin.Name.ToString() + " = MakeInt2(" +
					"LoadInt32(InputBuffers[" + FString::FromInt(IndexX) + "], Index), " +
					"LoadInt32(InputBuffers[" + FString::FromInt(IndexY) + "], Index));";
			}
			else if (Type.Is<FIntVector>())
			{
				...
				Result += "const int3 " + Pin.Name.ToString() + " = MakeInt3(" +
					"LoadInt32(InputBuffers[" + FString::FromInt(IndexX) + "], Index), " +
					"LoadInt32(InputBuffers[" + FString::FromInt(IndexY) + "], Index), " +
					"LoadInt32(InputBuffers[" + FString::FromInt(IndexZ) + "], Index));";
			}
			else if (Type.Is<FIntVector4>())
			{
				...
				Result += "const int4 " + Pin.Name.ToString() + " = MakeInt4(" +
					...
					"LoadInt32(InputBuffers[" + FString::FromInt(IndexY) + "], Index), " +
					"LoadInt32(InputBuffers[" + FString::FromInt(IndexZ) + "], Index), " +
					"LoadInt32(InputBuffers[" + FString::FromInt(IndexW) + "], Index));";
			}
			else if (Type.Is<int64>())
			{
				const int32 Index = BufferIndex++;
				Result += "const int64 " + Pin.Name.ToString() + " = LoadInt64(InputBuffers[" + FString::FromInt(Index) + "], Index);";
			}
			else if (Type.Is<FInt64Point>())
			{
				const int32 IndexX = BufferIndex++;
				const int32 IndexY = BufferIndex++;
				Result += "const long2 " + Pin.Name.ToString() + " = MakeLong2(" +
					"LoadInt64(InputBuffers[" + FString::FromInt(IndexX) + "], Index), " +
					"LoadInt64(InputBuffers[" + FString::FromInt(IndexY) + "], Index));";
			}
			else if (Type.Is<FInt64Vector>())
			{
				...
				const int32 IndexY = BufferIndex++;
				const int32 IndexZ = BufferIndex++;
				Result += "const long3 " + Pin.Name.ToString() + " = MakeLong3(" +
					"LoadInt64(InputBuffers[" + FString::FromInt(IndexX) + "], Index), " +
					"LoadInt64(InputBuffers[" + FString::FromInt(IndexY) + "], Index), " +
					"LoadInt64(InputBuffers[" + FString::FromInt(IndexZ) + "], Index));";
			}
			else if (Type.Is<FInt64Vector4>())
			{
				...
				const int32 IndexZ = BufferIndex++;
				const int32 IndexW = BufferIndex++;
				Result += "const long4 " + Pin.Name.ToString() + " = MakeLong4(" +
					"LoadInt64(InputBuffers[" + FString::FromInt(IndexX) + "], Index), " +
					"LoadInt64(InputBuffers[" + FString::FromInt(IndexY) + "], Index), " +
					"LoadInt64(InputBuffers[" + FString::FromInt(IndexZ) + "], Index), " +
					"LoadInt64(InputBuffers[" + FString::FromInt(IndexW) + "], Index));";
			}
			else
			{
				check(false);
	...
	for (const FVoxelPin& Pin : Node.GetPins())
	{
		...
		{
			Result += "int64 " + Pin.Name.ToString() + ";";
		}
		else if (Type.Is<FInt64Point>())
		{
			Result += "long2 " + Pin.Name.ToString() + ";";
		}
		else if (Type.Is<FInt64Vector>())
		{
			Result += "long3 " + Pin.Name.ToString() + ";";
		}
		else if (Type.Is<FInt64Vector4>())
		{
			Result += "long4 " + Pin.Name.ToString() + ";";
		}
		else
		{
			check(false);
...

	{
		...
		for (const FVoxelPin& Pin : Node.GetPins())
		{
			...
			{
				const int32 Index = BufferIndex++;
				Result += "StoreBool(OutputBuffers[" + FString::FromInt(Index) + "], Index, " + Pin.Name.ToString() + ");";
			}
			else if (Type.Is<uint8>())
			{
				const int32 Index = BufferIndex++;
				Result += "StoreByte(OutputBuffers[" + FString::FromInt(Index) + "], Index, " + Pin.Name.ToString() + ");";
			}
			else if (Type.Is<float>())
			{
				const int32 Index = BufferIndex++;
				Result += "StoreFloat(OutputBuffers[" + FString::FromInt(Index) + "], Index, " + Pin.Name.ToString() + ");";
			}
			else if (Type.Is<FVector2D>())
			{
				const int32 IndexX = BufferIndex++;
				const int32 IndexY = BufferIndex++;
				Result += "StoreFloat(OutputBuffers[" + FString::FromInt(IndexX) + "], Index, " + Pin.Name.ToString() + ".x);";
				Result += "StoreFloat(OutputBuffers[" + FString::FromInt(IndexY) + "], Index, " + Pin.Name.ToString() + ".y);";
			}
			else if (Type.Is<FVector>())
			{
				const int32 IndexX = BufferIndex++;
				...
				Result += "StoreFloat(OutputBuffers[" + FString::FromInt(IndexX) + "], Index, " + Pin.Name.ToString() + ".x);";
				Result += "StoreFloat(OutputBuffers[" + FString::FromInt(IndexY) + "], Index, " + Pin.Name.ToString() + ".y);";
				Result += "StoreFloat(OutputBuffers[" + FString::FromInt(IndexZ) + "], Index, " + Pin.Name.ToString() + ".z);";
			}
			else if (Type.Is<FQuat>() || Type.Is<FLinearColor>())
			{
				const int32 IndexX = BufferIndex++;
				...
				Result += "StoreFloat(OutputBuffers[" + FString::FromInt(IndexY) + "], Index, " + Pin.Name.ToString() + ".y);";
				Result += "StoreFloat(OutputBuffers[" + FString::FromInt(IndexZ) + "], Index, " + Pin.Name.ToString() + ".z);";
				Result += "StoreFloat(OutputBuffers[" + FString::FromInt(IndexW) + "], Index, " + Pin.Name.ToString() + ".w);";
			}
			else if (Type.Is<double>())
			{
				const int32 Index = BufferIndex++;
				Result += "StoreDouble(OutputBuffers[" + FString::FromInt(Index) + "], Index, " + Pin.Name.ToString() + ");";
			}
			else if (Type.Is<FVoxelDoubleVector2D>())
			{
				const int32 IndexX = BufferIndex++;
				const int32 IndexY = BufferIndex++;
				Result += "StoreDouble(OutputBuffers[" + FString::FromInt(IndexX) + "], Index, " + Pin.Name.ToString() + ".x);";
				Result += "StoreDouble(OutputBuffers[" + FString::FromInt(IndexY) + "], Index, " + Pin.Name.ToString() + ".y);";
			}
			else if (Type.Is<FVoxelDoubleVector>())
			{
				const int32 IndexX = BufferIndex++;
				...
				Result += "StoreDouble(OutputBuffers[" + FString::FromInt(IndexX) + "], Index, " + Pin.Name.ToString() + ".x);";
				Result += "StoreDouble(OutputBuffers[" + FString::FromInt(IndexY) + "], Index, " + Pin.Name.ToString() + ".y);";
				Result += "StoreDouble(OutputBuffers[" + FString::FromInt(IndexZ) + "], Index, " + Pin.Name.ToString() + ".z);";
			}
			else if (Type.Is<FVoxelDoubleQuat>() || Type.Is<FVoxelDoubleLinearColor>())
			{
				const int32 IndexX = BufferIndex++;
				...
				Result += "StoreDouble(OutputBuffers[" + FString::FromInt(IndexY) + "], Index, " + Pin.Name.ToString() + ".y);";
				Result += "StoreDouble(OutputBuffers[" + FString::FromInt(IndexZ) + "], Index, " + Pin.Name.ToString() + ".z);";
				Result += "StoreDouble(OutputBuffers[" + FString::FromInt(IndexW) + "], Index, " + Pin.Name.ToString() + ".w);";
			}
			else if (Type.Is<int32>() || Type.Is<FVoxelSeed>())
			{
				const int32 Index = BufferIndex++;
				Result += "StoreInt32(OutputBuffers[" + FString::FromInt(Index) + "], Index, " + Pin.Name.ToString() + ");";
			}
			else if (Type.Is<FIntPoint>())
			{
				const int32 IndexX = BufferIndex++;
				const int32 IndexY = BufferIndex++;
				Result += "StoreInt32(OutputBuffers[" + FString::FromInt(IndexX) + "], Index, " + Pin.Name.ToString() + ".x);";
				Result += "StoreInt32(OutputBuffers[" + FString::FromInt(IndexY) + "], Index, " + Pin.Name.ToString() + ".y);";
			}
			else if (Type.Is<FIntVector>())
			{
				const int32 IndexX = BufferIndex++;
				...
				Result += "StoreInt32(OutputBuffers[" + FString::FromInt(IndexX) + "], Index, " + Pin.Name.ToString() + ".x);";
				Result += "StoreInt32(OutputBuffers[" + FString::FromInt(IndexY) + "], Index, " + Pin.Name.ToString() + ".y);";
				Result += "StoreInt32(OutputBuffers[" + FString::FromInt(IndexZ) + "], Index, " + Pin.Name.ToString() + ".z);";
			}
			else if (Type.Is<FIntVector4>())
			{
				const int32 IndexX = BufferIndex++;
				...
				Result += "StoreInt32(OutputBuffers[" + FString::FromInt(IndexY) + "], Index, " + Pin.Name.ToString() + ".y);";
				Result += "StoreInt32(OutputBuffers[" + FString::FromInt(IndexZ) + "], Index, " + Pin.Name.ToString() + ".z);";
				Result += "StoreInt32(OutputBuffers[" + FString::FromInt(IndexW) + "], Index, " + Pin.Name.ToString() + ".w);";
			}
			else if (Type.Is<int64>())
			{
				const int32 Index = BufferIndex++;
				Result += "StoreInt64(OutputBuffers[" + FString::FromInt(Index) + "], Index, " + Pin.Name.ToString() + ");";
			}
			else if (Type.Is<FInt64Point>())
			{
				const int32 IndexX = BufferIndex++;
				const int32 IndexY = BufferIndex++;
				Result += "StoreInt64(OutputBuffers[" + FString::FromInt(IndexX) + "], Index, " + Pin.Name.ToString() + ".x);";
				Result += "StoreInt64(OutputBuffers[" + FString::FromInt(IndexY) + "], Index, " + Pin.Name.ToString() + ".y);";
			}
			else if (Type.Is<FInt64Vector>())
			{
				const int32 IndexX = BufferIndex++;
				...
				Result += "StoreInt64(OutputBuffers[" + FString::FromInt(IndexX) + "], Index, " + Pin.Name.ToString() + ".x);";
				Result += "StoreInt64(OutputBuffers[" + FString::FromInt(IndexY) + "], Index, " + Pin.Name.ToString() + ".y);";
				Result += "StoreInt64(OutputBuffers[" + FString::FromInt(IndexZ) + "], Index, " + Pin.Name.ToString() + ".z);";
			}
			else if (Type.Is<FInt64Vector4>())
			{
				const int32 IndexX = BufferIndex++;
				...
				Result += "StoreInt64(OutputBuffers[" + FString::FromInt(IndexY) + "], Index, " + Pin.Name.ToString() + ".y);";
				Result += "StoreInt64(OutputBuffers[" + FString::FromInt(IndexZ) + "], Index, " + Pin.Name.ToString() + ".z);";
				Result += "StoreInt64(OutputBuffers[" + FString::FromInt(IndexW) + "], Index, " + Pin.Name.ToString() + ".w);";
			}
			else
			{
				check(false);
