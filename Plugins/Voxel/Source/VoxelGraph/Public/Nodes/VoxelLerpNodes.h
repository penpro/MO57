...
struct VOXELGRAPH_API FVoxelTemplateNode_LerpBase : public FVoxelTemplateNode
{
	GENERATED_BODY()
...
struct FVoxelComputeNode_Lerp : public FVoxelComputeNode
{
	GENERATED_BODY()
	GENERATED_VOXEL_NODE_BODY()
	...
	{
		return "{ReturnValue} = lerp_NaN({A}, {B}, {Clamp} ? clamp({Alpha}, 0.f, 1.f) : {Alpha})";
	}
};
...
struct VOXELGRAPH_API FVoxelTemplateNode_Lerp : public FVoxelTemplateNode_LerpBase
{
	GENERATED_BODY()
	GENERATED_VOXEL_NODE_BODY()
	...
	{
		return FVoxelComputeNode_Lerp::StaticStruct();
	}
};
...
USTRUCT(meta = (Internal))
struct VOXELGRAPH_API FVoxelComputeNode_SmoothStep : public FVoxelComputeNode
{
	GENERATED_BODY()
	GENERATED_VOXEL_NODE_BODY()
	...
	virtual FString GenerateCode(FCode& Code) const override
	{
		return "{ReturnValue} = SmoothStep_NaN({A}, {B}, {Clamp} ? clamp({Alpha}, 0.f, 1.f) : {Alpha})";
	}
};
...
USTRUCT(Category = "Math|Misc")
struct VOXELGRAPH_API FVoxelTemplateNode_SmoothStep : public FVoxelTemplateNode_LerpBase
{
	GENERATED_BODY()
	GENERATED_VOXEL_NODE_BODY()
	...
	virtual UScriptStruct* GetInnerNode() const override
	{
		return FVoxelComputeNode_SmoothStep::StaticStruct();
	}
};