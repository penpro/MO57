...
struct VOXELGRAPH_API FVoxelNode_FilterBuffer : public FVoxelNode
{
	GENERATED_BODY()
...
struct VOXELGRAPH_API FVoxelTemplateNode_FilterBuffer : public FVoxelTemplateNode
{
	GENERATED_BODY()
	GENERATED_VOXEL_NODE_BODY()
...
public:
	TArray<FPinRef> BufferInputPins;
	TArray<FPinRef> BufferOutputPins;
