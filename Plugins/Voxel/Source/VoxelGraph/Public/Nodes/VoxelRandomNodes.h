...
UCLASS()
class VOXELGRAPH_API UVoxelRandomNodesFunctionLibrary : public UVoxelFunctionLibrary
{
	GENERATED_BODY()
...
struct FVoxelComputeNode_RandFloat : public FVoxelComputeNode
{
	GENERATED_BODY()
...
struct FVoxelComputeNode_RandomVector : public FVoxelComputeNode
{
	GENERATED_BODY()
	GENERATED_VOXEL_NODE_BODY()
...
USTRUCT(Category = "Random")
struct FVoxelComputeNode_RandomRotator : public FVoxelComputeNode
{
	GENERATED_BODY()
	GENERATED_VOXEL_NODE_BODY()
