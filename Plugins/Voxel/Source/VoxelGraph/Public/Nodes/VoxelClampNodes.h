...
struct VOXELGRAPH_API FVoxelTemplateNode_AbstractClampBase : public FVoxelTemplateNode
{
	GENERATED_BODY()
...
USTRUCT(meta = (Abstract))
struct VOXELGRAPH_API FVoxelTemplateNode_ClampBase : public FVoxelTemplateNode_AbstractClampBase
{
	GENERATED_BODY()
	GENERATED_VOXEL_NODE_BODY()
...
USTRUCT(meta = (Abstract))
struct VOXELGRAPH_API FVoxelTemplateNode_MappedClampBase : public FVoxelTemplateNode_AbstractClampBase
{
	GENERATED_BODY()
	GENERATED_VOXEL_NODE_BODY()
...
struct FVoxelComputeNode_Clamp_Float : public FVoxelComputeNode
{
	GENERATED_BODY()
	GENERATED_VOXEL_NODE_BODY()
...
USTRUCT(meta = (Internal))
struct FVoxelComputeNode_Clamp_Double : public FVoxelComputeNode
{
	GENERATED_BODY()
	GENERATED_VOXEL_NODE_BODY()
...
USTRUCT(meta = (Internal))
struct FVoxelComputeNode_Clamp_Int32 : public FVoxelComputeNode
{
	GENERATED_BODY()
	GENERATED_VOXEL_NODE_BODY()
...
USTRUCT(meta = (Internal))
struct FVoxelComputeNode_Clamp_Int64 : public FVoxelComputeNode
{
	GENERATED_BODY()
	GENERATED_VOXEL_NODE_BODY()

	VOXEL_TEMPLATE_INPUT_PIN(int64, Value, nullptr);
	VOXEL_TEMPLATE_INPUT_PIN(int64, Min, nullptr);
	VOXEL_TEMPLATE_INPUT_PIN(int64, Max, nullptr);
...
USTRUCT(Category = "Math|Misc", meta = (Keywords = "saturate"))
struct VOXELGRAPH_API FVoxelTemplateNode_Clamp : public FVoxelTemplateNode_ClampBase
{
	GENERATED_BODY()
	GENERATED_VOXEL_NODE_BODY()
	...
	{
		return FVoxelComputeNode_Clamp_Float::StaticStruct();
	}
	virtual UScriptStruct* GetDoubleInnerNode() const override
	{
		return FVoxelComputeNode_Clamp_Double::StaticStruct();
	}
	virtual UScriptStruct* GetInt32InnerNode() const override
	{
		return FVoxelComputeNode_Clamp_Int32::StaticStruct();
	}
	virtual UScriptStruct* GetInt64InnerNode() const override
	{
		return FVoxelComputeNode_Clamp_Int64::StaticStruct();
	}
};
...
USTRUCT(meta = (Internal))
struct FVoxelComputeNode_MappedRangeValueClamped_Float : public FVoxelComputeNode
{
	GENERATED_BODY()
	GENERATED_VOXEL_NODE_BODY()
...
USTRUCT(meta = (Internal))
struct FVoxelComputeNode_MappedRangeValueClamped_Double : public FVoxelComputeNode
{
	GENERATED_BODY()
	GENERATED_VOXEL_NODE_BODY()
...
USTRUCT(Category = "Math|Misc", meta = (Keywords = "remap"))
struct VOXELGRAPH_API FVoxelTemplateNode_MappedRangeValueClamped : public FVoxelTemplateNode_MappedClampBase
{
	GENERATED_BODY()
	GENERATED_VOXEL_NODE_BODY()
	...
	virtual UScriptStruct* GetFloatInnerNode() const override
	{
		return FVoxelComputeNode_MappedRangeValueClamped_Float::StaticStruct();
	}
	virtual UScriptStruct* GetDoubleInnerNode() const override
	{
		return FVoxelComputeNode_MappedRangeValueClamped_Double::StaticStruct();
	}
	virtual UScriptStruct* GetInt32InnerNode() const override
	{
		return nullptr;
...
USTRUCT(meta = (Internal))
struct FVoxelComputeNode_MappedRangeValueUnclamped_Float : public FVoxelComputeNode
{
	GENERATED_BODY()
	GENERATED_VOXEL_NODE_BODY()
...
USTRUCT(meta = (Internal))
struct FVoxelComputeNode_MappedRangeValueUnclamped_Double : public FVoxelComputeNode
{
	GENERATED_BODY()
	GENERATED_VOXEL_NODE_BODY()
...
USTRUCT(Category = "Math|Misc", meta = (Keywords = "remap"))
struct VOXELGRAPH_API FVoxelTemplateNode_MappedRangeValueUnclamped : public FVoxelTemplateNode_MappedClampBase
{
	GENERATED_BODY()
	GENERATED_VOXEL_NODE_BODY()
	...
	virtual UScriptStruct* GetFloatInnerNode() const override
	{
		return FVoxelComputeNode_MappedRangeValueUnclamped_Float::StaticStruct();
	}
	virtual UScriptStruct* GetDoubleInnerNode() const override
	{
		return FVoxelComputeNode_MappedRangeValueUnclamped_Double::StaticStruct();
	}
	virtual UScriptStruct* GetInt32InnerNode() const override
	{
		return nullptr;
