...
#if WITH_EDITOR
extern VOXELGRAPH_API bool GVoxelEnableNodeStats;
...
extern VOXELGRAPH_API TArray<IVoxelNodeStatProvider*> GVoxelNodeStatProviders;
#endif

class VOXELGRAPH_API FVoxelNodeStatScope
{
public:
