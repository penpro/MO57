...
protected:
	...
	{
		const TSharedRef<FVoxelGraphSearchItem> Child = MakeShared<T>(Forward<ArgTypes>(Args)...);
...
{
public:
	const TVoxelObjectPtr<const UVoxelTerminalGraph> WeakTerminalGraph;
...
{
public:
	const TVoxelObjectPtr<UEdGraphNode> WeakNode;
...
class FVoxelGraphSearchItem_FunctionInput : public FVoxelGraphSearchItem_Property
{
public:
	const FVoxelGraphFunctionInput Input;

	FVoxelGraphSearchItem_FunctionInput(
		const FGuid& Guid,
		const FVoxelGraphFunctionInput& Input)
	...
	virtual EVoxelGraphSearchResultTag GetTag() const override
	{
		return EVoxelGraphSearchResultTag::FunctionInput;
	}
	virtual void Build() override;
	//~ End FVoxelGraphSearchResult Interface
};

class FVoxelGraphSearchItem_FunctionOutput : public FVoxelGraphSearchItem_Property
{
public:
	FVoxelGraphSearchItem_FunctionOutput(
		const FGuid& Guid,
		const FVoxelGraphFunctionOutput& Output)
	...
	virtual EVoxelGraphSearchResultTag GetTag() const override
	{
		return EVoxelGraphSearchResultTag::FunctionOutput;
	}
	//~ End FVoxelGraphSearchResult Interface
};
