...
VOXEL_INITIALIZE_STYLE(GraphEditor)
{
	...
	Set("VoxelGraph.FindInGraph", new FSlateVectorImageBrush(CoreImageBrushSVG("Starship/Common/search"), Icon40x40));
	Set("VoxelGraph.FindInGraph.Small", new FSlateVectorImageBrush(CoreImageBrushSVG("Starship/Common/search"), Icon20x20));

	Set("VoxelGraph.FindInGraphs", new CORE_IMAGE_BRUSH_SVG("Starship/Common/FindInBlueprints", Icon40x40));
	Set("VoxelGraph.FindInGraphs.Small", new CORE_IMAGE_BRUSH_SVG("Starship/Common/FindInBlueprints", Icon20x20));
