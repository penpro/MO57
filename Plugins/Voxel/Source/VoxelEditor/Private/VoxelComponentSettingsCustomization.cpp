...
class FVoxelComponentSettingsCustomization : public FVoxelPropertyTypeCustomizationBase
{
public:
...
DEFINE_VOXEL_STRUCT_LAYOUT(FVoxelComponentSettings, FVoxelComponentSettingsCustomization);